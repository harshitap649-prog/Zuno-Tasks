...
export default function Dashboard({ user }) {
  ...
  const sidebarAdCode = import.meta.env.VITE_ADSTERRA_SIDEBAR_CODE;
  const inlineAdCode = import.meta.env.VITE_ADSTERRA_INLINE_CODE;
      ...
      <div className="card">
        ...
        <div className="hidden lg:block lg:col-span-3">
          <div className="sticky top-20">
            <SidebarAd adCode={sidebarAdCode} />
          </div>
        </div>
      </div>

      {/* Inline Ad - Mobile friendly, between sections */}
      {inlineAdCode && (
        <div className="mt-8 mb-4">
          <SidebarAd adCode={inlineAdCode} className="w-full" />
        </div>
      )}
    </div>
  );
